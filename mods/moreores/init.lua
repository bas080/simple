...
generate_ore("moreores:mineral_copper", "default:stone", minp, maxp, seed+16,   1/11/11/11,    9, -31000,  64)
generate_ore("moreores:mineral_tin", "default:stone", minp, maxp, seed+17,   1/8/8/8,    3, -31000,  8)
generate_ore("moreores:mineral_silver", "default:stone", minp, maxp, seed+18,   1/10/10/10,    6, -31000,  2)
generate_ore("moreores:mineral_gold", "default:stone", minp, maxp, seed+19,   1/12/12/12,    6, -31000,  -64)
generate_ore("moreores:mineral_mithril", "default:stone", minp, maxp, seed+20,   1/7/7/7,    1, -31000,  -512)
end)